...
import icon2 from '../../../assets/images/svgs/icon-Revenuebilled.svg';

const RevenueBilledWidgetOverview = () => {
  // chart color
...
export default RevenueBilledWidgetOverview;
