...
import icon2 from '../../../assets/images/svgs/icon-TAT.svg';

const TATWidgetOverview = () => {
  // chart color
  ...
  const seriescolumnchart = [
    {
      ...
      data: [15, 16, 14.5, 15.7], // Example data for the past 4 months
    },
  ];
    ...
    <BlankCard>
      <CardContent sx={{ p: '25px' }}>
        <Stack direction="row" spacing={2} alignItems="center">
          ...
          <Typography variant="h5">Turnaround Time</Typography>
        </Stack>
...
export default TATWidgetOverview;
